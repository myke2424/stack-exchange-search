...
public final class Http implements RequestSender {
  ...
  private HttpRequest buildRequest(String url, Map<String, String> params)
  ...
  private HttpResponse sendRequest(HttpRequest request, HttpResponse.BodyHandler handler)
