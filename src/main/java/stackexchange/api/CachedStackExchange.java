...
public final class CachedStackExchange implements Searchable {
  ...
  public List<SearchResult> search(SearchRequest request) {
    Gson gson = new Gson();
    String requestUri = Http.buildUri(this.service.getUrl(), request.toJsonMap());
    ...
    if (cachedSearchResultsJson.isPresent()) {
      ...
      List<SearchResult> searchResults = gson.fromJson(cachedSearchResultsJson.get(), listType);
